    ...
    public class Province
    {
        ...
        public Tuple<string, double>[] taxdetail
        {
            get
            {
                ...
                rslt.Add(new Tuple<string, double>("SHIZ", (GMData.Inist.countryTax.SHIZTax.curr - 1) * _taxbase/2));
                rslt.Add(new Tuple<string, double>("MIIN", (GMData.Inist.countryTax.MIINTax.curr - 1) * _taxbase/2));
